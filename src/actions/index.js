import { FETCH_CRYPTO_BY_CURRENCY, FETCH_CRYPTO_CURRENCY, FETCH_CURRENCY, GET_CURRENCY_LIST_URL, GET_CRYPTO_DATA_URL ,API_ERROR, ERROR_MSG} from '../constantsVar';
...
export const getCryptoData = () => {
    return async function (dispatch, getState) {
        try {
            ...
            dispatch({ type: API_ERROR, errorMessage: ERROR_MSG });
        }
    };
};
